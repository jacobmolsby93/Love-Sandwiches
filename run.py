...
def get_sales_data():
    ...
    Run a while loop to collect a vlaid string of data from the user
...
def get_last_5_entries_sales():
    """
    Collects collumns of data form sales worksheet, collecting
...
def calculate_stock_data(data):
    """
    Calculate the averege stock for each item type, adding 10%.
    """
    ...
    for column in data:
        ...
        averege = sum(int_column) / len(int_column)
        stock_num = averege * 1.1
